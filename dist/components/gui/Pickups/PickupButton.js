...
export function get_PickupButton(prendyAssets, storeHelpers) {
    ...
    return function PickupButton({ name }) {
        ...
        const handlePointerDown = (event) => setIsPressed(true);
        const handlePointerUp = (event) => setIsPressed(false);
        return (React.createElement("button", { 
            ...
            React.createElement("img", { src: pickupInfo.image, alt: name, draggable: false, 
                // width={50}
                // height={50}
                style: {
                    width: "7vmin",
