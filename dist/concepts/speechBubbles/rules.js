...
*/
export function makeSpeechBubbleRules(concepFuncs, backdopConcepts) {
    const { makeRules, setState, getRefs } = concepFuncs;
    const { getTypingDelayForLetter } = makeSpeechBubblesStoreUtils(concepFuncs, backdopConcepts);
