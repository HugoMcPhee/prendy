...
export function makeTyped_scenePlaneUtils(storeHelpers, prendyStartOptions) {
    ...
    function getScenePlanePositionOnScreen(thePosition) {
        ...
        //     .multiply(currentCamera.getProjectionMatrix());
        // }
        return Vector3.Project(thePosition, cachedParams.identityMatrix, currentCamera.getViewMatrix().multiply(currentCamera.getProjectionMatrix()), currentCamera.viewport.toGlobal(viewSize.width, viewSize.height));
    }
