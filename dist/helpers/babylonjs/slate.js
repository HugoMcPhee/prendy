...
export function get_slateUtils(storeHelpers, prendyStartOptions) {
    ...
    function getPositionOnSlate(theMesh) {
    ...
    function getSlatePositionNotOverEdges(slatePos, useGoal) {
    ...
    function updateSlatePositionToFocusOnMesh({ meshRef, instant }) {
    ...
    function focusSlateOnFocusedDoll(instant) {
    ...
    function checkPointIsInsideSlate(pointOnSlate) {
    ...
    function convertPointOnSlateToPointOnScreen({ pointOnSlate, // point on slate goes from 0 - 1280, 0 - 720, when the point is from the top left to bottom right
