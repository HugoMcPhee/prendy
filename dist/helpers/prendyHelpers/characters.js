...
export function get_characterStoryHelpers(storeHelpers, prendyStores, prendyOptions, modelInfoByName, characterNames) {
    ...
    const { moveDollAt2DAngle, setDollAnimation, setDollPosition, setDollRotationY, springAddToDollRotationY, springDollRotationY, } = get_dollStoryHelpers(storeHelpers, prendyOptions, modelInfoByName);
