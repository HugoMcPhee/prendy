...
export declare function makeTyped_spotStoryUtils<StoreHelpers extends PrendyStoreHelpers, A_PlaceName extends PlaceName = PlaceName, A_SpotNameByPlace extends SpotNameByPlace = SpotNameByPlace>(storeHelpers: StoreHelpers): {
