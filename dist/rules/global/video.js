...
export function get_globalVideoRules(storeHelpers, _prendyStores, prendyStartOptions, prendyAssets) {
    ...
    const { getSliceForPlace: getSliceForPlace, getSliceVidVideo: getSliceVidVideo, checkForVideoLoop, } = get_sliceVidUtils(storeHelpers, prendyStartOptions, prendyAssets);
