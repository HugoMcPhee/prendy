...
export declare function makeStartPrendyMainRules<T_MyTypes extends MyTypes = MyTypes>(storeHelpers: T_MyTypes["StoreHelpers"], prendyStores: T_MyTypes["Stores"], PRENDY_OPTIONS: T_MyTypes["Main"]["PrendyOptions"], prendyAssets: T_MyTypes["Assets"]): () => () => void;
...
export declare function makeStartPrendyRules<T_MyTypes extends MyTypes = MyTypes>({ customRules, prendyOptions, prendyAssets, stores, storeHelpers, }: MakeStartRulesOptions<T_MyTypes>): () => () => void;
