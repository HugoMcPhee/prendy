...
export declare function makeGetUsefulStoryStuff<StoreHelpers extends PrendyStoreHelpers>(storeHelpers: StoreHelpers): () => {
...
export declare function makeSetStoryState<StoreHelpers extends PrendyStoreHelpers>(storeHelpers: StoreHelpers): (newState: Partial<ReturnType<StoreHelpers["getState"]>["story"]["main"]>) => void;
