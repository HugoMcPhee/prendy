import { RenderTargetTexture, Color4, Constants, Texture, VertexBuffer, MaterialHelper, } from "@babylonjs/core";
 ...
 */
export class DepthRendererWithSize {
    /**
     ...
     */
    constructor(scene, type = Constants.TEXTURETYPE_FLOAT, camera = null, storeNonLinearDepth = false, customSize) {
        ...
        DepthRendererWithSize._SceneComponentInitialization(this._scene);
        this._camera = camera;
        var engine = scene.getEngine();
        // Render target
        var format = this.isPacked || engine.webGLVersion === 1
            ? Constants.TEXTUREFORMAT_RGBA
            : Constants.TEXTUREFORMAT_R;
        this._depthMap = new RenderTargetTexture("depthMap", { width: customSize.width, height: customSize.height }, this._scene, false, false, type, false, undefined, undefined, undefined, undefined, format);
        ...
        var renderSubMesh = (subMesh) => {
            ...
            if (this.isReady(subMesh, hardwareInstancedRendering) && camera) {
                ...
                // Draw
                renderingMesh._processRendering(effectiveMesh, subMesh, this._effect, material.fillMode, batch, hardwareInstancedRendering, (isInstance, world) => this._effect.setMatrix("world", world));
            }
        };
    ...
    isReady(subMesh, useInstances) {
        ...
        if (mesh.useBones && mesh.computeBonesUsingShaders) {
            ...
            defines.push("#define BonesPerMesh " +
        ...
        if (this._cachedDefines !== join) {
            ...
            ], ["diffuseSampler"], join, undefined, undefined, undefined, { maxSimultaneousMorphTargets: numMorphInfluencers });
        }
...
/** @hidden */
DepthRendererWithSize._SceneComponentInitialization = (_) => {
