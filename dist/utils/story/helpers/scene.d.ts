...
export declare function makeSceneStoryHelpers<ConcepFuncs extends BackdopConcepFuncs, A_AnyCameraName extends AnyCameraName = AnyCameraName, A_AnySegmentName extends AnySegmentName = AnySegmentName, A_CameraNameByPlace extends CameraNameByPlace = CameraNameByPlace, A_CharacterName extends CharacterName = CharacterName, A_PlaceInfoByName extends PlaceInfoByName = PlaceInfoByName, A_PlaceName extends PlaceName = PlaceName, A_SegmentNameByPlace extends SegmentNameByPlace = SegmentNameByPlace, A_SpotNameByPlace extends SpotNameByPlace = SpotNameByPlace, A_WallNameByPlace extends WallNameByPlace = WallNameByPlace>(concepFuncs: ConcepFuncs, placeInfoByName: A_PlaceInfoByName, characterNames: readonly A_CharacterName[]): {
    ...
    setSegment: <T_Place_2 extends A_PlaceName, T_Segment extends A_SegmentNameByPlace[T_Place_2]>(_placeName: T_Place_2, segmentName: T_Segment, whenToRun?: "now" | "at loop") => Promise<void>;
