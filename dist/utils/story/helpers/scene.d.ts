...
import { CharacterName, PlaceInfoByName, SpotNameByPlace } from "../../../declarations";
export declare function makeSceneStoryHelpers<ConcepFuncs extends BackdopConcepFuncs>(concepFuncs: ConcepFuncs, placeInfoByName: PlaceInfoByName, characterNames: readonly CharacterName[]): {
    ...
    setSegment: <T_Place_2 extends string, T_Segment extends string>(_placeName: T_Place_2, segmentName: T_Segment, whenToRun?: "now" | "at loop") => Promise<void>;
