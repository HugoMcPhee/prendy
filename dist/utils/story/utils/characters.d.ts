...
export declare function makeCharacterStoryUtils<ConcepFuncs extends PrendyConcepFuncs, A_CharacterName extends CharacterName = CharacterName, A_PlaceName extends PlaceName = PlaceName, A_SpotNameByPlace extends SpotNameByPlace = SpotNameByPlace>(concepFuncs: ConcepFuncs): {
