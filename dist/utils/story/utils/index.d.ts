...
export declare function makeBackdopStoryUtils<ConcepFuncs extends BackdopConcepFuncs, BackdopConcepts extends PlaceholderBackdopConcepts>(concepFuncs: ConcepFuncs, backdopConcepts: BackdopConcepts): {
    ...
    getSegmentFromStoryRules: <T_Place_1 extends string, T_Cam extends string>(place: T_Place_1, cam: T_Cam) => any;
    getSpotPosition: <T_Place_2 extends string>(place: T_Place_2, spot: string) => any;
    getSpotRotation: <T_Place_3 extends string>(place: T_Place_3, spot: string) => any;
};
