...
export declare function makeSpotStoryUtils<ConcepFuncs extends PrendyConcepFuncs, A_PlaceName extends PlaceName = PlaceName, A_SpotNameByPlace extends SpotNameByPlace = SpotNameByPlace>(concepFuncs: ConcepFuncs): {
