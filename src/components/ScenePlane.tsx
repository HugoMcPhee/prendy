  ...
  return function ScenePlane(_: Props) {
    const planeRef = useCallback((node) => {
      ...
      if (globalRefs.scenePlaneCamera) {
        const scene = globalRefs.scenes.main as Scene;
        const sceneCam = globalRefs.scenePlaneCamera as TargetCamera;
        const scenePlane = globalRefs.scenePlane as AbstractMesh;
