...
>(prendyAssets: A_PrendyAssets) {
  ...
  class StateReturnType_Generic_Helper<T_A extends A_DollName, T_B extends A_ModelName> {
    // wrapped has no explicit return type so we can infer it
    wrapped(a: T_A, b: T_B) {
      return state<T_A, T_B>(a, b);
    }
  }
  type StateReturnType<T_A extends A_DollName, T_B extends A_ModelName> = ReturnType<
  ...
  type DollStartStates = {
    [K_DollName in A_DollName]: StateReturnType<K_DollName, A_DollOptions[K_DollName]["model"]>;
  };
